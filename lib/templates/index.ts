...
1. attributionYearMonth (귀속년월) ★ 최우선 추출
   - YYYY-MM 형식
   - 문서에서 "귀속연월", "귀속년월", "귀속월" 키워드 바로 옆/아래의 날짜를 찾으세요
   - 날짜 형식 변환 규칙:
     * "2025년 1월", "2025.01", "25/01", "2025-01" → "2025-01"
     * "25년 1월" → "2025-01"
   - 이 필드는 반드시 추출해야 합니다. 문서를 꼼꼼히 확인하세요.
   - 예: "2025-01"

2. paymentYearMonth (지급연월) ★ 최우선 추출
   - YYYY-MM 형식
   - 문서에서 "지급연월", "지급년월", "지급월" 키워드 바로 옆/아래의 날짜를 찾으세요
   - 날짜 형식 변환은 귀속년월과 동일
